  ...
  return (
    <Layout>
      ...
      <p>
        ...
        They are supposed to take a single 3D vertex and plot it onto a 2D
        plane, optionally, with a 3rd axis value which is used to signify it's
        depth value, which is stored in a buffer (called the Z-buffer).
      </p>
      <p>
