...
import { modelVertices, modelNormals, modelIndices } from "./model-fixed"
...
const ShadowMappingFixedModelAreaLightShadowExample = () => {
  const scene = {
...
export default ShadowMappingFixedModelAreaLightShadowExample
